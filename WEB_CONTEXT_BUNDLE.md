...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-450-erd-s-problem-450-5d61ec03-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-450"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-450-erd-s-problem-450-5d61ec03-v1",
      "problem_contract_sha256": "0880b990a142f3a790cfafd3c4703e53ac5f7b7e29a7b1ab0fb26a2b434d418e",
      "problem_id": "problem:um-ep-450-erd-s-problem-450-5d61ec03",
      "route_id": "route:um-ep-450-erd-s-problem-450-5d61ec03-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-450-erd-s-problem-450-5d61ec03-source-fidelity-01",
      "graph_id": "graph:um-ep-450-erd-s-problem-450-5d61ec03-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-450-erd-s-problem-450-5d61ec03-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-450-erd-s-problem-450-5d61ec03-root",
          "statement": {
          ...
          "statement_sha256": "26cde71fa24495bb4d00e4b9a36f967ba9814cb7764c252c20365df25d69c962"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-450-erd-s-problem-450-5d61ec03-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-450-erd-s-problem-450-5d61ec03-root",
      "route_id": "route:um-ep-450-erd-s-problem-450-5d61ec03-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-450-75440d5e0a2a",
        "url": "https://www.unsolvedmath.com/problems/EP-450"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
